...
describe("AmusementParksIndexPage tests", () => {
    ...
    test("renders correct fields", () => {
        ...
        const createAmusementParksButton = screen.getByText("Create AmusementParks");
    ...
    test("delete button calls delete and reloads page", async () => {
        ...
        const expectedMessage = `AmusementParksIndexPage deleteCallback: {"id":3,"name":"Disneyland Park","description":"Disney-themed amusement park rides"}`;
